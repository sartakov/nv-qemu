...
DEF("nvram-path", HAS_ARG, QEMU_OPTION_nvrampath,
    "-nvram-path FILE  provide backing storage for guest RAM\n", QEMU_ARCH_ALL)
STEXI
@item -nvram-path @var{path}
Use memory image from file, a.k.a. Non-volatile memory created file in @var{path}.
ETEXI
